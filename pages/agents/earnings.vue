<template>
  <div>
      ...
      >
        <template #header>
          <div class="flex justify-between">
            <DashboardTitle text="Earnings" badge-label="10" show-badge />
            <UButton
          ...
          <p class="text-sm text-gray-500">Summary of your earnings</p>
        </template>
        ...
        >
          <template #empty-state>
            <div class="flex flex-col items-center justify-center py-48 gap-3">
              ...
              <span class="italic text-sm">No earnings yet!</span>
              <UButton
                icon="i-heroicons-plus-16-solid"
                label="Add"
                @click="isOpen = true"
          ...
          <template #source-data="{ row }">
            <UBadge
              :label="row.source"
              :color="row.source === 'Vacant Soon' ? 'primary' : 'gray'"
              variant="subtle"
            />
          </template>
    ...
    <UModal v-model="isOpen" prevent-close>
      <EarningForm :earning="earning" @close="handleFormClose" />
    </UModal>

    <UModal v-model="isDeleteOpen" prevent-close>
      <EarningDelete :earning="earning" @close="isDeleteOpen = false" />
    </UModal>
  </div>
</template>
...
const apartments = [
  ...
  {
    id: 3,
    apartment: 'Self Contained apartment',
    rent: '800,000',
    percetage: '10%',
    commission: '80,000',
    source: 'External',
